        ...
        <div class=" flex flex-wrap items-center justify-between mx-auto xl:py-4 xl:px-32 p-4">
          ...
          <div class="flex flex-wrap items-center justify-between xl:gap-10 sm:gap-0 md:order-2">
            <button
              ...
              aria-expanded="false"
              class="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-10 focus:outline-none rounded-lg text-sm p-2.5 mr-1"
            >
              <svg
                class="w-5 h-5"
                aria-hidden="true"
            ...
            <div class="relative hidden md:block">
              ...
              <input
                type="text"
                id="search-navbar"
                class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-black-500"
                placeholder="Search..."
              />
            </div>
            ...
            <div
              class="z-50 hidden my-4 text-base list-none"
              id="user-dropdown"
            >
          ...
          <div
            class="hidden flex flex-grow lg:pl-10 items-center justify-between  w-full md:flex md:w-auto md:order-1"
            id="navbar-search"
          >
            ...
            <ul class="flex flex-col items-center justify-center lg:gap-10 font-small md:flex-row">
              <li>
                <a href="#" class="text-1xl text-primer1" aria-current="page">
                  Home
                </a>
              </li>
              <li>
                <a href="#" class="text-1xl text-primer1">
                  E-Learning
                </a>
              </li>
              <li>
