    ...
    <>
        <div className=" mx-[128px] my-[56px] flex flex-col gap-[40px]">
            <div className="tab-buttons flex gap-[48px] font-bold text-[32px]">
                <button onClick={() => openTab('tab1')} className="tab-button ${activeTab === 'tab1' ? 'active' : ''} active:bg-blue-200 active:shadow-md active:shadow-lg py-[16px] px-[16px] rounded-[8px] transition duration-300 cursor-pointer hover:bg-primer4"><span>Academy</span></button>
                <button onClick={() => openTab('tab2')} className="tab-button ${activeTab === 'tab2' ? 'active' : ''} active:bg-blue-200 active:shadow-md active:shadow-lg py-[16px] px-[16px] rounded-[8px] transition duration-300 cursor-pointer hover:bg-primer4"><span>Webinar</span></button>
                <button onClick={() => openTab('tab3')} className="tab-button ${activeTab === 'tab3' ? 'active' : ''} active:bg-blue-200 active:shadow-md active:shadow-lg py-[16px] px-[16px] rounded-[8px] transition duration-300 cursor-pointer hover:bg-primer4"><span>Counseling</span></button>
            </div>
                            ...
                            <div className="px-[16px] pb-[16px]">
                                ...
                                <div className="flex flex-col gap-[16px]">
                                    <div className="flex gap-[8px] text-[14px] justify-between items-center">
                                        <div className="flex gap-[8px] pt-2">
                    ...
                    <div className="flex justify-between items-start">
                        <div className="flex flex-col gap-[16px] items-start shadow-xl w-[337px] rounded-[8px]">
                            ...
                            <div className="px-[16px] pb-[16px]  w-[100%]">
                                ...
                                <div className="flex pt-2 text-[14px] justify-between items-center">
                                    <div className="flex gap-[8px] ">
