  ...
  return (
    ...
    <div className='flex justify-between items-start w-full px-[128px] py-[56px]'>
        <div className='flex flex-col w-[240px] gap-4'>
            ...
            <button onClick={() => openTab('tab1')} className="tab-button ${activeTab === 'tab1' ? 'active' : ''} active:bg-primer3 active:shadow-md active:shadow-lg py-[8px] flex justify-start items-center gap-4 px-[16px] rounded-[8px] transition duration-300 cursor-pointer hover:bg-primer3">
                <Icon icon="iconamoon:profile" width="41" />
                <p className='text-[18px]'>Profile</p>
            </button >
            <button onClick={() => openTab('tab2')} className="tab-button ${activeTab === 'tab2' ? 'active' : ''} active:bg-primer3 active:shadow-md active:shadow-lg py-[8px] flex justify-start items-center gap-4 px-[16px] rounded-[8px] transition duration-300 cursor-pointer hover:bg-primer3">
                <Icon icon="icon-park-outline:personal-privacy" width="41" />
                <p className='text-[18px]'>Personal Data</p>
            </button >
            <button onClick={() => openTab('tab3')} className="tab-button ${activeTab === 'tab3' ? 'active' : ''} active:bg-primer3 active:shadow-md active:shadow-lg py-[8px] flex justify-start items-center gap-4 px-[16px] rounded-[8px] transition duration-300 cursor-pointer hover:bg-primer3">
